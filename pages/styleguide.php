...
/**
 * Ce fichier sert de bac à sable pour tester les composants du framework Arcane.
 * Il inclut désormais une gestion dynamique du mode clair/sombre.
 */
...
require_once ROOT_PATH . '/helpers/view.php';
?>
<!DOCTYPE html>
        ...
        tailwind.config = {
            ...
            theme: {
                extend: {
                    ...
                    colors: {
                        // Utilisation de variables CSS pour une adaptation automatique
                        arcane: {
                            900: 'var(--arcane-900)',
                            800: 'var(--arcane-800)',
                            700: 'var(--arcane-700)',
...
<body class="bg-arcane-900 bg-glow-light dark:bg-glow-dark text-mystic-900 dark:text-mystic-100 font-ui p-8 antialiased min-h-screen transition-colors duration-500">
    ...
    <script>
        ...
        // Initialisation : Vérifier la préférence stockée ou celle du système
