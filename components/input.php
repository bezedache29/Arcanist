...
// Base des styles
$baseInputClass = "w-full bg-arcane-900/50 dark:bg-arcane-700 text-mystic-900 dark:text-mystic-100 border rounded-lg px-4 py-2.5 font-ui transition-all duration-300 focus:outline-none focus:ring-1 placeholder-mystic-900/30 dark:placeholder-mystic-100/30";
