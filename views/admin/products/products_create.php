...
<div class="bg-white dark:bg-slate-800 shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 sm:rounded-xl overflow-hidden transition-colors max-w-3xl">
    <div class="p-6 sm:p-8">
        ...
        <form action="/pages/admin/products/products_create.php" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="price" id="price" required class="mt-1 block w-full rounded-md border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 py-2 px-3 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-900 dark:text-white transition-colors">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="1" min="0" name="stock" id="stock" required class="mt-1 block w-full rounded-md border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 py-2 px-3 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-900 dark:text-white transition-colors">
                </div>
            </div>
                        ...
                        <?php foreach ($categories as $category): ?>
                            <label class="relative flex items-start cursor-pointer">
                                <div class="flex h-6 items-center">
                                    <input type="checkbox" name="category_ids[]" value="<?= $category['id'] ?>" class="h-4 w-4 rounded border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-blue-600 focus:ring-blue-600 transition-colors">
                                </div>
