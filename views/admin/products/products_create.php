...
<div class="mb-8">
    ...
    <?php render_component('title', ['text' => 'Ajouter un produit', 'level' => 1]); ?>
    ...
    <div class="p-6 sm:p-8">
        ...
        <form action="/pages/admin/products/products_create.php" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <div class="mt-1 flex items-center gap-6">
                    ...
                    <div id="preview-placeholder"
                         class="shrink-0 h-24 w-24 flex items-center justify-center rounded-xl border-2 border-dashed border-arcane-700 text-arcane-700 bg-arcane-900/50">
            ...
            <?php render_component('textarea', [
                'name'        => 'description',
                'label'       => 'Description',
                'placeholder' => 'Décrivez les propriétés et usages de ce produit…',
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="flex flex-col gap-1.5">
                    <label for="stock" class="<?= $labelClass ?>">
                        Stock initial <span class="text-arcane-500 ml-0.5">*</span>
                    </label>
            ...
            <div class="border-t border-arcane-700/50 pt-6">
                ...
                <?php if (empty($categories)): ?>
                    <?php render_component('alert', [
                        'type'    => 'warning',
                        'message' => 'Aucune catégorie disponible. Créez-en une dans le menu Catégories.',
                    ]); ?>
                <?php else: ?>
